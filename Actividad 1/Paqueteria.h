...
class Paqueteria  //  LISTA SIMPLEMENTE LIGADA  //
{
    private:
        class Nodo{  // CLASE NODO //;
            ...
            public:
                Nodo():sig(nullptr){};
                friend class Paqueteria; // Nodo y Paqueteria Clases amigas
                };
...
template<class T>
void Paqueteria<T>::ordenar(){ // Metodo de burbuja
...
template<class T>
void Paqueteria<T>::guardar(string nomArch)const{
...
template<class T>
void Paqueteria<T>::recuperar(string nomArch){
